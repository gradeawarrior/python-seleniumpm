...
not use it to ask questions about how to use SeleniumPM. These questions should
...
3. Make sure you provide a suitable amount of information to work with. This
   ...
   - Tell us **what version of SeleniumPM you're using**, and
     **how you installed it**. Different versions of SeleniumPM behave
     differently and have different bugs, and some distributors of SeleniumPM
